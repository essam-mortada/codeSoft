        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    ...
                    <!-- Create New Project -->
                    <form action="{{route('projects.store')}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                            <label for="" class="form-label"> Name</label>
                            <input type="text" class="form-control rounded-pill" name="name" id="inputName5">
                            @error('name')
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control rounded-pill" name="description" id="inputEmail5">
                            @error('description')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="date" class="form-control rounded-pill" name="deadline" id="inputAddress5" >
                            @error('deadline')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
