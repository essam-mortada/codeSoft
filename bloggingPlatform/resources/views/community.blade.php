...
<div class="container">
    ...
    <div class="card col-md-3 m-auto my-2 text-center" style="box-shadow: 0 2px 4px rgba(190, 190, 190, 0.5), 0 4px 8px rgba(0, 0, 0, 0.2); border-radius:15px 15px; overflow:hidden; background:#1977cc">
        <div class="card-body">
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-7 m-auto">
            <div class="social-feed-box" style="box-shadow: 0 2px 4px rgba(190, 190, 190, 0.5), 0 4px 8px rgba(0, 0, 0, 0.2); border-radius:15px 15px; overflow:hidden;">
                ...
                <div class="social-avatar">
                    <a href="{{route('users.show',$post->user->id)}}" class="pull-left">
                        ...
                        <img src="{{asset('assets/img/male-profile.png')}}" alt="" class="img-fluid">
                        @elseif ($post->user->profile_picture==null && $post->user->gender=="female")
                        <img src="{{asset('assets/img/female-profile.png')}}" alt="" class="img-fluid">
                        @else
                        <img src="{{asset("storage/".$post->user->profile_picture)}}" alt="" class="img-fluid">
                        @endif
                    </a>
                ...
                <div class="social-body">
                    ...
                    <div class="text-center">
                        <a style="cursor: pointer;" id="imgblur" onclick="toggleBlurred()" class="blurred"><img style="max-width: 100%; height:auto;" src="{{asset("storage/".$post->attachments)}}" class="img-responsive img-fluid"></a>
                    </div>
                    @endif
                    <div class="btn-group">
                        ...
                        <form action="{{route('posts.downvote',$post->id)}}" method="POST">@csrf<button type="submit" class="btn btn-white btn-xs"><i class="fa fa-thumbs-down text-danger"></i> {{$post->downvotes}} dislike</button></form>
                ...
                <div class="social-footer">
                    ...
                    <div class="social-comment">
                        ...
                        <a href="" class="pull-left">
                            ...
                            <img src="{{asset('assets/img/female-profile.png')}}" alt="" class="img-fluid">
                            @else
                            <img src="{{asset("storage/".$comment->user->profile_picture)}}" alt="" class="img-fluid">
                            @endif
                        </a>
